function [d,pt_poly] = pointToPolyDist(pt,polyVertices) 
%%Computes distance from point to polygon whose vertices are specified by the
%              vectors xv and yv
% Input:  
%    pt - point's coordinate
%    polyVertices - vector of polygon vertices coordinates
% Output: 
...
%    pt_poly: coordinate of the point in the polygon closest to x,y
